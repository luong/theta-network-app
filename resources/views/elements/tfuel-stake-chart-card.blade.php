    ...
    <div class="card-body">
        <div class="container">
            <div class="chart-title text-center">
                Supply: {{ Helper::formatNumber($networkInfo['tfuel_supply'], 0, 'M') }} ({{ ($networkInfo['tfuel_supply_change_24h'] > 0 ? '+' : '') . Helper::formatNumber($networkInfo['tfuel_supply_change_24h'], 2, 'M') }})
